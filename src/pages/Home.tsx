            ...
            <div className="animate-fade-in">
              <div className="mt-12 relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-0">
                    <span className="font-glory text-[14vw] sm:text-[10vw] md:text-[7.5vw] lg:text-[6.5vw] xl:text-[83px] 2xl:text-[100px] leading-none uppercase tracking-wider text-yellow-500" style={{ marginLeft: '-230px' }}>
                      Arona
                    </span>
